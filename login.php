      ...
      <a class="dropdown-item" href="Arts.html">Arts</a>
       ...
       <li class="nav-item">
        ...
        <form method="post" action="login.php">
            ...
            <img class="displayed" src="pictures\avatar.png" alt="avatar" style="width:200px;height:3oopx;">
            <br><br>
            <label class="d-flex justify-content-center"for="email"><b><p style="color:rgb(22, 45, 10); font-size:x-large;">Email:</p><b></label>
            <input class="displayed" type="text" name="email" id = "email" placeholder="Enter Email" required>
            <label class="d-flex justify-content-center"for="pwd"><b><p style="color:rgb(22, 45, 10);font-size:x-large">Password:</p><b></label>
            <input class="displayed" type="password" name="password" id="pwd" maxlength=20 placeholder="Enter Password" required  br><br>
            <button type="submit" class="displayed" Style="width: 250px;"  class="btn btn-primary" style="border-radius:0" name="login_user">LOGIN</button>
        </div>  
     ...
     <div class="d-flex justify-content-center"style="margin-top:30px">
       <form class="form-inline">
         <div class="input-group">
           <input type="text" class="form-control  mr-sm-2" size="50" placeholder="Your email" >
